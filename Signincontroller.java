...
public class Signincontroller {
    ...
    public Optional<Signinmodel> updateUserDetails(@RequestParam Long userId, @RequestBody Signinmodel userDetails) {
        return userService.updateUserDetails(userId, userDetails.getAddress(), userDetails.getPhoneNumber());     }
