...
import camp from '../images/homeback.jpg'
  ...
  return (
    <div className='Aboutus'>
      ...
      <div className='content-journey'>
          <h2 style={{textAlign:"center",userSelect:'none' , color:'black'}}>OUR JOURNEY</h2>
        ...
        <div className='content-journey'>
        <hr></hr>
  <h2 style={{ textAlign: "center",userSelect:'none' ,color:'black'
  }}>Our Programs</h2>
  <div className='level'>
  ...
  <hr></hr>
    ...
    <div className='box2'>
      <div className='box-content2'>
        ...
        <Button variant="outlined" onClick={()=>navigate('/Courses')}>Join Free classes</Button>
      </div>
    </div>
    <div className='box2'>
      <div className='box-content2'>
      <text style={{fontFamily:'', fontWeight:'100px',fontSize:'25px'}}>Tournements</text>
        ...
        <br></br>
        <Button variant='outlined' onClick={()=> navigate('/Tournment')}> Join Tournments</Button>
      </div>
    </div>
    <div className='box2'>
      <div className='box-content2'>
      <text style={{fontFamily:'', fontWeight:'100px',fontSize:'25px'}}>JOIN CAMP</text>
        ...
        <Button variant='outlined' onClick={()=> navigate('/Camp')}> Join Champ</Button>
      </div>
    </div>
      </div>
      </div>
